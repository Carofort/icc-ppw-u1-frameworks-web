...
function limpiarTodo() {
    ...
    if (!confirm('¿Está seguro de eliminar todas las tareas?')) return;
...
function aplicarTema(nombreTema) {
    ...
    if (nombreTema === 'oscuro') {
        ...
        document.documentElement.style.setProperty('--bg-secondary', '#1e1e1e'); // Para botones y tareas
        ...
        document.documentElement.style.setProperty('--input-bg', '#fffffff');
...
if (tareas.length === 0) {
    mostrarMensaje('👋 ¡Bienvenid@! Agrega tu primera tarea', 'success');
}